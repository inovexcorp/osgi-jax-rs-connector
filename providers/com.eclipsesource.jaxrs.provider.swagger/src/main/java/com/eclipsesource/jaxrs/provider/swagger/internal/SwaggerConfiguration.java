...
public class SwaggerConfiguration implements ManagedService {
	...
	private static final String[] INFO_KEYS = new String[] { PROPERTY_INFO_TITLE, PROPERTY_INFO_DESCRIPTION, PROPERTY_INFO_VERSION, PROPERTY_INFO_TERMS, PROPERTY_INFO_CONTACT_NAME, PROPERTY_INFO_CONTACT_URL, PROPERTY_INFO_CONTACT_EMAIL, PROPERTY_INFO_LICENSE_NAME, PROPERTY_INFO_LICENSE_URL };
